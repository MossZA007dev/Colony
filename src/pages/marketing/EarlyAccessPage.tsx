  ...
  return (
    <MarketingShell goTo={goTo} currentPage={currentPage}>
      <PageHero
        ...
        subtitle="We are inviting a small number of founders and teams to shape the early Colony Bridge workspace. Tell us what you would like AI Ant to handle, and we will contact selected users with an invitation."
      />
