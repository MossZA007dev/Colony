  ...
  return (
    <MarketingShell goTo={goTo} currentPage={currentPage}>
      <PageHero
        ...
        subtitle="Where we are today, what is next, and what comes later. Updated as early users shape the product."
        accent="teal"
      />
      ...
      <section className="px-5 pb-24 md:px-8">
        <div className="mx-auto max-w-[1100px] rounded-[24px] border border-white/[0.08] bg-white/[0.025] p-8 text-center md:p-10">
          ...
          <p className="mx-auto mt-3 max-w-[560px] text-[14px] text-white/55">
            Early users get a direct line to the team. The roadmap moves with what real workflows actually need.
          </p>
          <button
