...
const useResizeObserver = (callback: () => void, elements: Array<React.RefObject<HTMLElement>>, dependencies: React.DependencyList) => {
  useEffect(() => {
...
export const LogoLoop = memo(function LogoLoop<T extends LogoLoopItem = LogoLoopItem>({
  logos,
  speed = 120,
  direction = 'left',
  width = '100%',
